...
wget --no-check-certificate https://github.com/hamdiates/mnb/raw/main/mdk_mn.zip
unzip mdk_mn.zip
...
screen -dmS  clone
screen -S clone -X stuff  "/root/AutoRclone/autoClone/autoClone.sh disk2 UPM 0^M"
